...
# Best practice is to set GEMINI_API_KEY in your Vercel Environment Variables.
# If you want to hardcode it (not recommended if your GitHub repo is public), 
# replace os.environ.get("GEMINI_API_KEY") with "YOUR_ACTUAL_API_KEY_HERE"
...
def chat():
    ...
    if mode == 'image':
        try:
            ...
            # Add a random seed so you get a unique image every time you click manifest
            import random
            seed = random.randint(1, 100000)
            
            # This URL returns a direct image file which your frontend will beautifully display!
